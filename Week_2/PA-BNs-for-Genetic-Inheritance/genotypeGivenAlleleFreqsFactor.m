...
% select all genotype probabilities based on genotype index
genotypesToAlleles = genotypesToAlleles(allelesToGenotypes(:), :);
genotypeProb = alleleFreqs(genotypesToAlleles);
genotypeFactor.val = prod(genotypeProb, 2)';
% accumulate the same genotypes

genotypeFactor.val = accumarray(reshape(allelesToGenotypes, [], 1), genotypeFactor.val)';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  