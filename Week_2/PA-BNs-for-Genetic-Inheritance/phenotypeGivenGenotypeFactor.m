...
hasPhysicalTraitIndex = 1: 2: prod(phenotypeFactor.card);
noPhysicalTraitIndex = 2: 2: prod(phenotypeFactor.card);

phenotypeFactor.val(hasPhysicalTraitIndex) = alphaList;
phenotypeFactor.val(noPhysicalTraitIndex) = 1 - alphaList;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%